...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.53 2015/08/18 14:43:11 tantau Exp $
...
\def\pgfsys@new@id#1{\global\let#1\pgfutil@empty}
% Creates a new id and stores it in the macro #1.

\def\pgfsys@use@id#1{}
% The next graphics object (group or path) will get id
% assigned. The id must previously have been created using
% \pgfsys@new@id and each id may be used only once.
