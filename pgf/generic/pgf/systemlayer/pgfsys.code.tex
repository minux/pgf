...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.83 2016/03/11 14:04:04 tantau Exp $
...
\def\pgfsys@begin@idscope{%
  \begingroup%
    ...
    \expandafter\global\expandafter\let\csname pgf@sys@att@setup@\pgfsys@id@refcurrent\endcsname\relax%
