...
% #1 is the id of a sync base, #2 is an optional offset, #3 is the
% target. 
...
% #1 is the optional id of another element, #2 is an event name, and #3 is 
% an optional offset, #4 is the target. 

\def\pgfsys@animation@repeat@event#1#2#3#4{}
% #1 is the optional id of another element, #2 is a repeat count, and
