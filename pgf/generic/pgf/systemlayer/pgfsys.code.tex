...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.74 2016/02/02 22:03:39 tantau Exp $
...
%
% "staged" works like "visibility", only the object is hidden by default.
% Type: text ("visible" or "hidden")
%
...
% Declares that the next graphics object is resource #1

\def\pgfsys@rdf@property#1{\pgf@sys@fail{rdf}}
% Declares that the next graphics object has property #1 
