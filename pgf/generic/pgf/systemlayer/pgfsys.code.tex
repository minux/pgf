...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.95 2016/07/05 20:13:33 tantau Exp $
...
\def\pgfsys@begin@guardscope{}
% For some drivers (most noticably, for SVG) each graphic state change
% must be placed in a scope begin. These must then closed
% appropriately. For these drivers, guard scopes can be added.

\def\pgfsys@end@guardscope{}
% Closes a guard scope.
