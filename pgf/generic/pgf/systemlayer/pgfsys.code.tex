...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.49 2015/08/13 14:08:31 tantau Exp $
...
\def\pgfsys@begin@animation@scope{\pgfsys@beginscope}
...
\def\pgfsys@end@animation@scope{\pgfsys@endscope}
