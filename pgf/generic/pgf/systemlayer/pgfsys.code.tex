...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.72 2015/12/28 13:19:07 tantau Exp $
...
%
% "stage" adds an animation of the staging: While the stage animation is not
% running, the object will be hidden, while it is running, it will be shown. 
% Type: none
%
% "linewidth" adds an animation of the line width.
% Type: dimension
%
% "dashphase" adds an animation of the dash phase.
% Type: dimension
%
% "dashpattern" adds an animation of the dash array.
% Type: dash array
%
