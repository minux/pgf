...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.64 2015/10/01 16:03:06 tantau Exp $
...
\def\pgfsys@animation@default@pace{}
% Specifies that the pacing of the animation should be whatever is the
% default for the particular kind of animation (spline or paced).

\def\pgfsys@animation@paced{}
% Specifies that the animation must be paced.
