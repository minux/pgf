...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.78 2016/03/07 00:11:13 tantau Exp $
...
%
% "stage" works like "visibility", only the object is hidden by default.
% Type: text ("visible" or "hidden")
%
