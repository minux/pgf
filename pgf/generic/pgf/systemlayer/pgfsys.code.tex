...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.79 2016/03/08 21:50:14 tantau Exp $
...
% Specifies that the animation must be paced. The start- and end-times
% are taken from the first and last entry of the timeline.
