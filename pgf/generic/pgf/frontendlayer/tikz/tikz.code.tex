...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.170 2016/03/11 14:04:04 tantau Exp $
...
% Animation callbacks
\let\tikz@animation@callback\relax
\let\tikz@animation@node@callback\relax
\tikzset{
  animate/.code=\tikzerror{You need to say \string\usetikzlibrary{animations} to use animations},
  animate me/.style={animate={myself:={#1}}},
}

% Resource description framework
\tikzset{
  rdf/.code=% does nothing by default
}
    ...
    \setbox\pgfnodeparttextbox=\hbox%
      \bgroup%
        ...
        \pgfinterruptpicture%
          ...
          \bgroup%
            \aftergroup\unskip%
            % Color stuff has been moved from here to outside; this is
