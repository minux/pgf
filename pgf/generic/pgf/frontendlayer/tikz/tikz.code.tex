...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.165 2016/02/18 19:12:47 tantau Exp $
...
\tikzset{
  ...
  animate with/.style={animate={with=#1}},
  animate me with/.style={animate={myself:={with={#1}}}}
}
