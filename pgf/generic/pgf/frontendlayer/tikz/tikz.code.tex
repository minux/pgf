...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.160 2015/08/28 11:25:38 tantau Exp $
...
\tikzset{/tikz/animations/whom/.code=}
...
\def\tikz@do@animation@option#1{%
  ...
  {%
    \pgfkeys{/tikz/animations/whom/.expanded=[#1]\tikz@whom}%
    \tikz@animate@options%
  }%
  \let\tikz@animate@options=\pgfutil@empty%
}
