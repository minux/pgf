...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.176 2016/04/25 14:58:37 tantau Exp $
...
% RDF stuff
\let\tikz@rdf@options\pgfutil@empty
\def\tikz@clear@rdf@options{\let\tikz@rdf@options\pgfutil@empty}%
\def\tikz@do@rdf@options{\tikz@rdf@options\let\tikz@rdf@options\pgfutil@empty}%
