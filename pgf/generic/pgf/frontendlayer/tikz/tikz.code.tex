...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.175 2016/03/22 14:57:33 tantau Exp $
...
\let\tikz@id@hook@begin\pgfutil@empty
\let\tikz@id@hook@end\pgfutil@empty

\def\tikz@call@id@hook{\ifx\tikz@id@hook\pgfutil@empty\else\tikz@id@hook\pgfuseid{\tikz@id@name}\fi}
\def\tikz@clear@id@hook@begin@end{%
  \let\tikz@id@hook@begin\pgfutil@empty%
  \let\tikz@id@hook@end\pgfutil@empty%
}
...
\def\tikz@finish{%
  ...
  %
  \iftikz@mode@clip\else\endgroup\tikz@id@hook@end\endpgfidscope\fi%
  % 
