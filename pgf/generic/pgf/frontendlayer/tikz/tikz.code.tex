...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.155 2015/08/18 23:56:36 tantau Exp $
...
\def\tikz@@scope@env[#1]{%
  ...
  \ifx\tikz@id@name\pgfutil@empty\else\pgfnewid{\tikz@id@name}\pgfuseid{\tikz@id@name}{}\pgfsys@begin@idscope\fi%
  \begingroup%
    \let\tikz@id@name\pgfutil@empty%
...
\def\endtikz@scope@env{%
    \tikz@atend@scope%
  \endgroup%
  \ifx\tikz@id@name\pgfutil@empty\else\pgfsys@end@idscope\fi%
          ...
          \pgfinterruptpath%
            \pgfscope%
              ...
              \ifx\tikz@id@name\pgfutil@empty%
                \ifx\tikz@animate@options\pgfutil@empty%
                \else%
                  \def\pgfnodeid{g@node}%
                  \pgfuseid{g@node}{}%
                  \pgfsys@begin@idscope%
                \fi%
              \else%
                \pgfgaliasid{\tikz@id@name}{g@node}%
                \def\pgfnodeid{g@node}%
                \pgfuseid{g@node}{}%
                \pgfsys@begin@idscope%
              \fi%
