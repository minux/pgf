...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.163 2015/11/06 21:16:02 tantau Exp $
...
\def\tikz@animation@syntax@check#1#2{#2}
      ...
      {%
        ...
        \else%
          ...
          \expandafter\ifx\csname pgf@sh@s@\tikz@key\endcsname\relax%
            % Forth chance: An animation
            \tikz@animation@syntax@check{#1}{%
