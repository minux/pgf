...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/tikzlibraryanimations.code.tex,v 1.5 2015/08/18 23:56:36 tantau Exp $
...
\def\tikz@animate@now#1#2#3#4{%
  {%
    ...
    \tikz@anim@general@parse#4...\pgf@stop%
