...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/tikzlibraryanimations.code.tex,v 1.40 2016/03/16 23:32:38 tantau Exp $
...
%  along in/.style={scope={time=0,value=0,entry,time=#1,value=1,entry}}
}
...
\def\tikz@anim@create#1#2#3{%
  ...
  \edef\tikz@temp{\csname tikz@anim@def@pgf@attr@#2\endcsname}%
