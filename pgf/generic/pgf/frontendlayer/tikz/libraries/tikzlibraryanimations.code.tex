...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/tikzlibraryanimations.code.tex,v 1.33 2016/03/10 23:26:17 tantau Exp $
...
\def\tikz@animation@with#1do#2\pgf@stop#3{%
  \begingroup%
    ...
    \ifx\tikz@anim@tail\pgfutil@empty\else%
      \begingroup%
