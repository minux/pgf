...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/tikzlibraryanimations.code.tex,v 1.4 2015/08/18 16:22:37 tantau Exp $
...
\def\tikz@animate@now#1#2#3{%
  {%
    ...
    \iftikz@animate@in@path%
      \def\tikz@temp{#1}%
      \ifx\tikz@temp\tikz@softpathtext%
        \ifx\tikz@animate@whom\pgfutil@empty%
           \def\tikz@animate@whom{g@path}%
        \fi%
      \fi%
    \fi
    \tikz@animate@now@%
