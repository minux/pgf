...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/tikzlibraryanimations.code.tex,v 1.18 2015/11/26 22:22:28 tantau Exp $
...
\tikzanimationsanimatesset{
  ...
  dash phase/.style={@attribute=dash phase/},
  dash pattern/.style={@attribute=dash pattern/, @parser=dashpattern},
  ...
  view/.style={@attribute=view/{@type scope=.view},@parser=view},
  ...
  motion/.style={@attribute=motion/, add},
  ...
  % Along parser
  along/.code=\tikz@anim@along{#1}{\tikz@anim@timeline@name}
}
...
\tikzanimationsset{
  ...
  default animates/.style={
    ...
    dash pattern/animates={dash pattern},
    dash phase/animates={dash phase},
    fill/animates={fill},
    draw/animates={draw},
    text/animates={text},
    view/animates={view},
...
\def\tikz@anim@parse@time@done{%
  \pgfutil@ifnextchar\pgf@stop{\pgfutil@gobble}{\tikz@anim@parse@time@one}%
}
\def\tikz@anim@parse@time@one#1{%
  \pgfkeys{/tikz/animations/.cd,#1}%
  \tikz@anim@parse@time@done%
}
