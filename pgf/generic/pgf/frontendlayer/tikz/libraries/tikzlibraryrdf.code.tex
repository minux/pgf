...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/tikzlibraryrdf.code.tex,v 1.4 2016/04/27 22:53:01 tantau Exp $
...
\def\tikz@rdf@parse@{%
  \pgfutil@ifnextchar\tikzrdfhashmark{\tikz@rdf@parse@id}{%
