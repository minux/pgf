...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleanimation.code.tex,v 1.1 2015/08/13 14:08:31 tantau Exp $
...
\pgfanimationset{
  whom/.code={%
    ...
    \ifx\pgf@anim@temp\relax%
      \pgferror{No animation scope named '#1'}
    \else%
...
% Begins an animation after the most recent animation.
% 
% #1 = an optional dealy.
% 
% A shorthand for "begin on={of=most recent animation,delay=#1}"
