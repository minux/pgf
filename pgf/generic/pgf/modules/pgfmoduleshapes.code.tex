...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleshapes.code.tex,v 1.36 2015/08/19 11:45:37 tantau Exp $
...
\def\pgfmultipartnode#1#2#3#4{%
  ...
  {%
    {%
      ...
      {\pgfsys@get@type\pgf@type@temp\pgfusetype{.foreground}\csname pgf@sh@fg@#1\endcsname#4\pgfusetype{\pgf@type@temp}}%
