...
% Certain parts of a node have special names:

\pgfnewidtype{text}
\pgfnewidtype{background}
\pgfnewidtype{behind background}
\pgfnewidtype{before background}
\pgfnewidtype{foreground}
\pgfnewidtype{behind foreground}
\pgfnewidtype{before foreground}
\pgfgaliasidtype{path}{background}
...
\def\pgfmultipartnode#1#2#3#4{%
  ...
  {%
    {%
      ...
      {{\pgf@possibly@useid{behind background}\pgfscope\csname pgf@sh@bbg@#1\endcsname\endpgfscope}}%
      \pgfutil@ifundefined{pgf@sh@bg@#1}{%
        \global\let\pgfpositionnodelaterpath\pgfutil@empty%
      }%
      {\pgf@possibly@useid{background}\csname pgf@sh@bg@#1\endcsname%
        \ifpgflatenodepositioning%
      ...
      {{\pgf@possibly@useid{before background}\pgfscope\csname pgf@sh@fbg@#1\endcsname\endpgfscope}}%
      {%
        \expandafter\pgfutil@for\expandafter\pgf@shape@com\expandafter:\expandafter=\csname pgf@sh@boxes@#1\endcsname\do{%
          {%
            \ifx\pgf@shape@com\pgf@texttext%
              \pgf@possibly@useid{text}%
            \fi%
      ...
      {{\pgf@possibly@useid{behind foreground}\pgfscope\csname pgf@sh@bfg@#1\endcsname\endpgfscope}}%
      \pgfutil@ifundefined{pgf@sh@fg@#1}{}%
      {\pgf@possibly@useid{foreground}\csname pgf@sh@fg@#1\endcsname#4}%
      \pgfutil@ifundefined{pgf@sh@ffg@#1}{}%
      {{\pgf@possibly@useid{before foreground}\pgfscope\csname pgf@sh@ffg@#1\endcsname\endpgfscope}}%
      \ifpgflatenodepositioning%
...
\def\pgf@possibly@useid#1{\ifx\pgfnodeid\pgfutil@empty\else\pgfuseid{\pgfnodeid}{#1}\fi}
\let\pgfnodeid\pgfutil@empty%
\def\pgf@texttext{text}
