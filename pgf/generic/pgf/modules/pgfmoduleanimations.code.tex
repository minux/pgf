...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleanimations.code.tex,v 1.27 2016/03/08 21:50:14 tantau Exp $
...
\def\pgfsnapshot#1#2{\pgfsyssnapshot{#1}{-}{#2}}
\def\pgfsnapshotafter#1#2{\pgfsyssnapshot{#1}{+}{#2}}
