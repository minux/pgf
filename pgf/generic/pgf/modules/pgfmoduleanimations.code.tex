...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleanimations.code.tex,v 1.28 2016/03/09 11:27:52 tantau Exp $
...
\def\pgfsnapshot#1#2{\pgfparsetime{#1}\expandafter\pgfsyssnapshot\expandafter{\pgftimeresult}{-}{#2}}
\def\pgfsnapshotafter#1#2{\pgfparsetime{#1}\expandafter\pgfsyssnapshot\expandafter{\pgftimeresult}{+}{#2}}
...
\pgfanimationset{
  paced/.is choice,
  paced/true/.code=\pgfsysanimkeypaced,
  paced/false/.code=\pgfsysanimkeyspline,
  paced/.default=true
}
