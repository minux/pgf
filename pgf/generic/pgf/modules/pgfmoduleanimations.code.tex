...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleanimations.code.tex,v 1.6 2015/08/18 23:56:36 tantau Exp $
...
\def\pgfanimateattribute#1#2{%
  {%
    \pgfnewid{g@animation}%
    \pgfaliasid{@animation}{g@animation}% make local
...
\pgfanimationset{
  whom/.code=\pgf@anim@decomp{#1}\pgfifid{\pgf@anim@id@name}{\pgfsys@animation@whom{\pgf@anim@id}{\pgf@anim@type}}{\pgferror{No animation scope named '\pgf@anim@id@name' known}}
}
...
\def\pgf@anim@decomp@#1.#2\pgf@stop{%
  ...
  \def\pgf@anim@id{\pgfrefid{#1}}%
  \def\pgf@anim@type{\pgfreftype{#2}}%
}
...
\def\pgfanim@make@event#1#2{%
  ...
  \ifx\pgfanim@event@key\pgfutil@empty%
    \ifx\pgfanim@event@repeat\pgfutil@empty%
      ...
      \else%
        \pgfsys@animation@event{\pgf@anim@id}{\pgf@anim@type}{\pgfanim@event@event}{\pgfanim@event@delay}{#2}%
      \fi%
    \else%
      \pgfsys@animation@repeat@event{\pgf@anim@id}{\pgf@anim@type}{\pgfanim@event@repeat}{\pgfanim@event@delay}{#2}%
    \fi%
  \else%
...
\pgfkeys{/pgf/animation/events/.cd,
  ...
  of/.code=\pgf@anim@decomp{#1}\pgfifid{\pgf@anim@id@name}{}{\pgferror{Unknown animation name '\pgf@anim@id@name'}},
