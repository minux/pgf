...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleanimations.code.tex,v 1.5 2015/08/18 16:22:37 tantau Exp $
...
\pgfanimationset{
  whom/.code=\pgfifid{#1}{\pgfsys@animation@whom{\pgfrefid{#1}}}{\pgferror{No animation scope named '#1' known}}
}

\def\pgf@relaxtext{\relax}
...
\pgfkeys{/pgf/animation/events/.cd,
  ...
  of/.code=\pgfifid{#1}{\edef\pgfanim@event@id{\pgfrefid{#1}}}{\pgferror{Unknown animation name '#1'}},
