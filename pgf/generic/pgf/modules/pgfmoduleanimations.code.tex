...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleanimations.code.tex,v 1.38 2016/06/23 18:55:02 tantau Exp $
...
\def\pgf@anim@prep@marker@arrow#1#2#3{%
  ...
  \expandafter\let\expandafter#3\csname pgfanim@marker@cache@l\pgf@anim@marker@id@list\endcsname%
