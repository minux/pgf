...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleanimations.code.tex,v 1.24 2016/02/02 22:03:39 tantau Exp $
...
\pgfkeys{/pgf/@animation attributes/.cd,
  stage/.code=\pgf@animate@attr{stage}{mapped}\def\pgf@anim@map@true{visible}\def\pgf@anim@map@false{hidden},
  ...
  dash phase/.code=\pgf@animate@attr{dashphase}{dimension},
  dash pattern/.code=\pgf@animate@attr{dashpattern}{dashpattern},
}
...
\def\pgfanim@parse@type@scaling#1{%
  ...
  \else%
    \pgfmathparse{#1}%
    \expandafter\pgfsysanimvalscale\expandafter{\pgfmathresult}{}%
  \fi%
}
...
% 
% #1 is a dash pattern as in \pgfsetdash
%
% entry = {0s}{{1pt}{2pt}{3pt}{1pt}}

\def\pgfanim@parse@type@dashpattern#1{%
  \def\pgf@temp{}%
  \def\pgf@next{\pgf@strip}%
  \pgf@strip#1{pgf@stop}%
  \expandafter\pgfsysanimvaldashpattern\expandafter{\pgf@temp}%
}
