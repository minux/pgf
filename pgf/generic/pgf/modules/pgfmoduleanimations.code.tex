...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleanimations.code.tex,v 1.8 2015/08/19 22:47:27 tantau Exp $
...
\def\pgfanim@parse@type@mapped#1#2{%
  {%
    ...
    \fi%
  \expandafter}%
  \expandafter\pgfsys@animation@text\expandafter{\pgf@temp}{#2}%
}
