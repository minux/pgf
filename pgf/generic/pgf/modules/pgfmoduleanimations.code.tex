...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleanimations.code.tex,v 1.12 2015/09/14 22:32:50 tantau Exp $
...
\pgfanimationset{
  ...
  key spline control/.code n args={4}{%
    ...
    \pgfmathsetmacro\pgfanim@cont@b{#2}%
    \pgfmathsetmacro\pgfanim@cont@c{#3}%
    \pgfmathsetmacro\pgfanim@cont@d{#4}%
