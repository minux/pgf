...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcoretransformations.code.tex,v 1.25 2015/11/26 22:22:28 tantau Exp $
...
\def\pgf@pos@transform@glob{%
  ...
  \else%
    ...
    \advance\pgf@x by\pgf@pt@ba\pgf@y%
