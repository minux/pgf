...
% Description:
%
% Later of #1 can be passed to \pgfuseid.
...
% a hyperlink. The name can be reused and is set globally.

\def\pgfuseid#1{\expandafter\pgfsys@use@id\csname pgf@scope@name@#1\endcsname}
...
% Description:
% 
% Will expand to the id of a previously named scope.
