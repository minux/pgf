  ...
  \ifx\pgf@up@clip\pgfutil@empty%
    ...
    \else%
      ...
      \ifpgfutil@tempswa%
        ...
        \ifpgfarrow@marker\pgfarrow@marker@setup@end\fi%
        \begingroup%
          \pgf@prepare@start@of@path%
          \ifpgfarrow@marker\pgfarrow@marker@setup@begin\fi%
      \fi%
          \pgfsyssoftpath@invokecurrentpath%
          \pgf@up@action%
          ...
          \fi%
      \ifpgfutil@tempswa%
          \ifpgfarrow@marker\else\pgf@add@arrow@at@start\fi%
        \endgroup%
        \ifpgfarrow@marker\else\pgf@add@arrow@at@end\fi%
      \fi%
    \fi%
  \else%
    \pgfsyssoftpath@invokecurrentpath%
...
%
% Setup an end arrow tip as a marker
%
